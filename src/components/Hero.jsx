...
const bio =
  "I'm Oladipupo, a full-stack developer who turns ideas into real, working products. I specialize in building high-performance web apps, e-commerce platforms, and backend systems using React, Node.js, NestJS, and FastAPI. I care deeply about clean UI, solid architecture, and creating experiences users actually enjoy. If you're building something impactful and need someone who can execute end-to-end let's connect";
